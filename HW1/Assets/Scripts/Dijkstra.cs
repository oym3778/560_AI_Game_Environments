...
public class Dijkstra : MonoBehaviour
{
                                     ...
                                     Stack<NodeRecord> path = null)
    {
        ...
        while (open.Count > 0)
        {
            ...
            print("This is the smallest node" + current.node.name);
            ...
            foreach (GameObject connection in connections.Values)
            {
                ...
                else if (Contains(open, endNode))
                {
                    ...
                    if (endNodeRecord.cost <= endNodeCost) // TODO This may cause an error... endNodeRecord.costSoFar != endNodeRecord.cost in the book
                    {
                        continue;
                    }
                }
...
public class NodeRecord
{
    ...
    public Dictionary<Direction, NodeRecord> connections = new Dictionary<Direction, NodeRecord>();
